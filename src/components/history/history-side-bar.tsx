...
import { SidebarLeftIcon,ResetPasswordIcon, Cancel01Icon } from "@hugeicons/core-free-icons";
      ...
      <Tooltip content="聊天历史" side="left" sideOffset={4}>
        <Drawer.Trigger asChild>
          <Button variant="ghost" size="iconSm">
            <HugeiconsIcon icon={SidebarLeftIcon} size={20}  strokeWidth={2} />
          </Button>
        </Drawer.Trigger> 
      </Tooltip>
              ...
              <div className="flex flex-row justify-between">
                <div className="p-2">
                  <Flex
                    ...
                    gap="sm"
                  >
                      <HugeiconsIcon icon={ResetPasswordIcon} size={18} /> 最近聊天
                  </Flex>
                </div>
