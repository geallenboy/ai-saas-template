...
export function LoginForm({
  ...
  const handleGithubLogin = async () => {
    try {
      ...
      setLoginError(error.message || 'GitHub登录失败')
    ...
    <div className={`w-full space-y-6 sm:space-y-8 ${className}`}>
        ...
        <div className="space-y-1 sm:space-y-2">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className={`pl-10 sm:pl-12 py-2.5 sm:py-3 text-base sm:text-lg border-2 focus:border-blue-500 transition-colors duration-300 ${errors.email ? 'border-red-500' : ''
                }`}
        ...
        <div className="space-y-1 sm:space-y-2">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className={`pl-10 sm:pl-12 pr-10 sm:pr-12 py-2.5 sm:py-3 text-base sm:text-lg border-2 focus:border-blue-500 transition-colors duration-300 ${errors.password ? 'border-red-500' : ''
                }`}
              disabled={isEmailSubmitting || isGoogleSubmitting}
      ...
      <div className="space-y-4">
        ...
        <Button
          ...
          className="w-full"
          variant="outline"
          disabled={isGoogleSubmitting || isGithubSubmitting}
        >
          {isGoogleSubmitting ? (
            <div className="flex items-center justify-center">
        ...
        >
          {isGithubSubmitting ? (
            <div className="flex items-center justify-center">
              <Loader2 className="w-4 h-4 animate-spin mr-2" />
              <span className="animate-pulse">正在跳转到 GitHub...</span>
            </div>
          ) : (
            <div className="flex items-center justify-center">
