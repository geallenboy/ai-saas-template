        ...
        <div className="max-w-md w-full space-y-6 sm:space-y-8">
          ...
          <div className="text-center">
            ...
            <p className="mt-2 text-sm sm:text-base text-gray-600 dark:text-gray-400">
              Join our AI intelligent community
            </p>
          </div>
        ...
        <div className="relative z-10 flex items-center justify-center p-8 xl:p-12">
          <div className="text-center text-white max-w-md xl:max-w-lg">
            <h3 className="text-3xl xl:text-4xl font-bold mb-4 xl:mb-6">
              Start Your Intelligent Future
            </h3>
            <p className="text-lg xl:text-xl opacity-90 mb-6 xl:mb-8 leading-relaxed">
              Experience cutting-edge AI technology,
              <br className="hidden xl:block" />
              let intelligent tools empower your work.
            </p>
            <div className="flex items-center justify-center gap-6 xl:gap-8">
              <div className="text-center">
                <div className="text-2xl xl:text-3xl font-bold">AI</div>
                <div className="text-xs xl:text-sm opacity-75">Assistant</div>
              </div>
              <div className="text-center">
                <div className="text-2xl xl:text-3xl font-bold">24/7</div>
                <div className="text-xs xl:text-sm opacity-75">Available</div>
              </div>
              <div className="text-center">
                <div className="text-2xl xl:text-3xl font-bold">∞</div>
                <div className="text-xs xl:text-sm opacity-75">
                  Possibilities
                </div>
              </div>
            </div>
