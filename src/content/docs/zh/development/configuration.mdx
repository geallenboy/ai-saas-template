...
export const appConfig = {
  ...
  meta: {
    ...
    description: '使用 Next.js 15、React 19、tRPC 和 Better Auth 构建现代 AI SaaS 应用',
  ...
  // 社交媒体链接
  social: {
    github: https://git.n.xiaomi.com/miui_security_fe/ai-saas-template',
...
这个更新后的配置管理文档完全基于当前项目的技术架构，包括 Better Auth、tRPC、Stripe 支付、多 AI 服务提供商等现代化的配置管理方式。
